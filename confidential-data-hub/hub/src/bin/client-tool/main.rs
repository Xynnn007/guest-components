...
use api::*;
use api_ttrpc::{GetResourceServiceClient, SealedSecretServiceClient, SecureMountServiceClient};
use base64::{engine::general_purpose::STANDARD, Engine};
use clap::{Args, Parser, Subcommand};
use keyprovider::*;
use keyprovider_ttrpc::KeyProviderServiceClient;
...
async fn main() {
    ...
    match args.operation {
        Operation::UnsealSecret(arg) => {
            ...
            let res = client
                .unseal_secret(context::with_timeout(50 * 1000 * 1000 * 1000), &req)
                .await
        ...
        Operation::UnwrapKey(arg) => {
            ...
            let res = client
                .un_wrap_key(context::with_timeout(50 * 1000 * 1000 * 1000), &req)
                .await
                .expect("request to CDH");
        ...
        Operation::SecureMount(arg) => {
            ...
            let res = client
                .secure_mount(context::with_timeout(50 * 1000 * 1000 * 1000), &req)
                .await
                .expect("request to CDH");
