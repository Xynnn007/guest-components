...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x17attestation-agent.proto\x12\x11attestation_agent\"\x13\n\x11GetTee\
    TypeRequest\"&\n\x12GetTeeTypeResponse\x12\x10\n\x03Tee\x18\x01\x20\x01(\
    ...
    eMeasurementRequest\x12\x16\n\x06Events\x18\x01\x20\x03(\x0cR\x06Events\
    \x12)\n\rRegisterIndex\x18\x02\x20\x01(\x04H\0R\rRegisterIndex\x88\x01\
    ...
    CheckInitDataRequest\x12\x16\n\x06Digest\x18\x01\x20\x01(\x0cR\x06Digest\
    \"\x17\n\x15CheckInitDataResponse2\x91\x04\n\x17AttestationAgentService\
    \x12Y\n\nGetTeeType\x12$.attestation_agent.GetTeeTypeRequest\x1a%.attest\
    ation_agent.GetTeeTypeResponse\x12\\\n\x0bGetEvidence\x12%.attestation_a\
    gent.GetEvidenceRequest\x1a&.attestation_agent.GetEvidenceResponse\x12S\
    \n\x08GetToken\x12\".attestation_agent.GetTokenRequest\x1a#.attestation_\
    agent.GetTokenResponse\x12\x83\x01\n\x18ExtendRuntimeMeasurement\x122.at\
    testation_agent.ExtendRuntimeMeasurementRequest\x1a3.attestation_agent.E\
    xtendRuntimeMeasurementResponse\x12b\n\rCheckInitData\x12'.attestation_a\
    gent.CheckInitDataRequest\x1a(.attestation_agent.CheckInitDataResponseb\
    \x06proto3\
";
